    ...
    <section className={className}>
      ...
      <div className='flex flex-col md:flex-row justify-around gap-8'>
        ...
        <div className='flex flex-col items-left my-16 w-full'>
          ...
          <iframe className='w-full h-64' src="https://www.youtube.com/embed/zXr1FKg41f4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>          </a>
        ...
        <div className='flex flex-col items-left my-16 w-full'>
          ...
          <div className='p-4'>
          <iframe className='w-full h-64' src="https://www.youtube.com/embed/ZjatZvDDbXk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          <div className='flex justify-evenly mt-4'>
