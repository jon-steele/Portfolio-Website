...
export default function Projects({className}) {
  return (
    <div className={className}>
      ...
      <h1 className='text-4xl text-center mb-8'>My Projects</h1>
      ...
      <div className='flex flex-col md:flex-row justify-around'>
        ...
        <div className='flex flex-col items-left'>
          <div className='flex flex-col justify-top'>
            ...
            <ul className='font-nun font-medium font-lg bg-slate-200 text-gray-700 list-disc list-inside rounded-md'>
          ...
          <a href='https://www.voci.app' target="_blank" rel="noreferrer"><Image className='' src={vocipng} alt='image of voci' /></a>
            <div className='flex justify-evenly mt-4'>
              <a href='https://www.voci.app' target="_blank" rel="noreferrer"><h1 className='bg-slate-200 text-gray-700 rounded-md'>www.voci.app</h1></a>
              <a href='https://github.com/jon-steele/voci' target="_blank" rel="noreferrer"><h1 className='bg-slate-200 text-gray-700 rounded-md'>Source Code</h1></a>
            </div>
          </div>
        </div>
