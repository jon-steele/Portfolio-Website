  ...
  return(
    <div className={className}>
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        <h1 className="px-4 py-2 text-4xl mb-4 text-slate-200 bg-gray-700 rounded-md animate h-full items-start">Languges</h1>
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        <h1 className="px-4 py-2 text-4xl mb-4 text-slate-200 bg-gray-700 rounded-md animate h-full items-start">Frameworks</h1>
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        <h1 className="px-4 py-2 text-4xl mb-4 text-slate-200 bg-gray-700 rounded-md animate h-full items-start">Tools</h1>
