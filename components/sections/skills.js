  ...
  return(
    <div className={className}>
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        <h1 className="text-4xl text-slate-200 bg-gray-700 rounded-md animate">Languges</h1>
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        <h1 className="text-4xl text-slate-200 bg-gray-700 rounded-md animate">Frameworks</h1>
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        <h1 className="text-4xl text-slate-200 bg-gray-700 rounded-md animate">Tools</h1>
