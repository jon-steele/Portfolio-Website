    ...
    <div className="w-full">
        <div className={className}> 
            ...
            <p className="text-left font-nun text-xl md:text-2xl lg:text-3xl leading-10 !important font-normal break-words">
                ...
                In my studies, I excelled in my algorithms & data structures courses, achieving a <em className="font-bold">4.0 GPA </em> 
                in my final three semesters.
                I have strong foundational knowledge in web technologies, programming languages, design models, and time complexity.
                In 2020, I was awarded <em className="font-bold">Employee of the Year</em> at my previous job as a lifeguard.
                In my spare time, I enjoy learning about new technologies, recently adding Docker into my skillset.
